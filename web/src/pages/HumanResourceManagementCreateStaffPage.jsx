...
const HumanResourceManagementCreateStaffPage = () => {
      ...
      <DashboardContainer>
        ...
        <TableContainerContent style={{ gridColumn: "span 8", gridRow: "span 6" }}>
          <FormField style={{ gridColumn: "span 8", gridRow: "span 1" }}>
            <KpiPerStaffStatusComponent currentStep={1} title={'Tạo Nhân Viên Mới'} />
          </FormField>
          ...
          <FormField style={{ gridColumn: 'span 2', gridRow: 'span 3' }}>
            <AllFileUploadButton title="Ảnh" onFileChange={handleFileChange} />
          </FormField>
...
export default HumanResourceManagementCreateStaffPage;
